...
public class Arduino
{
    ...
    private final static int RESET_COMMAND = 6;
    
    //SENSOR SUBCOMMANDS
    private final static int PING_SUBCOMMAND = 0;
    
    //RESET SUBCOMMANDS
    private final static int HARDRESET_SUBCOMMAND = 0;
    ...
    //Start the process of a hard reset on the arduino board - with jumper to reset pin
    public void hardReset(int resetPin) {
        serialWrite(RESET_COMMAND);
        serialWrite(HARDRESET_SUBCOMMAND);
        serialWrite(resetPin);
    }
